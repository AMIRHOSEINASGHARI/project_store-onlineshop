    ...
    <section className="w-full space-y-10">
      <div className="w-full h-[250px] lg:h-[350px] relative group">
        ...
        >
          ...
          <div className="w-[360px] absolute bottom-0 z-20 right-[20px] xl:right-[50px] max-lg:hidden group-hover:-translate-x-[20px] group-hover:-translate-y-[10px] group-hover:rotate-2 transition1">
            <Image
